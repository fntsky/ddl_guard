...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/ddl/{uuid}": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update DDL Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/ddl/{uuid}/status": {
            "patch": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Update DDL Status Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/final-grades/{final_grade_uuid}/homework-scores": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create Homework Score Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/final-grades/{final_grade_uuid}/quiz-scores": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Create Quiz Score Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/homework-scores/{uuid}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Homework Score UUID",
                        "name": "uuid",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Update Homework Score Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/quiz-scores/{uuid}": {
            "put": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Quiz Score UUID",
                        "name": "uuid",
                        "in": "path",
                        "required": true
                    },
                    {
                        "description": "Update Quiz Score Request",
                        "name": "req",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/api/v1/users/email/verification-codes": {
            "post": {
        ...
        "/api/v1/users/password/reset-codes": {
            "post": {
        ...
        "/api/v1/users/phone/login-verification-codes": {
            "post": {
        ...
        "/api/v1/users/phone/verification-codes": {
            "post": {
        ...
        "/api/v1/users/registrations/email": {
            "post": {
        ...
        "/api/v1/users/registrations/phone": {
            "post": {
        ...
        "/api/v1/users/sessions/phone/code": {
            "post": {
        ...
        "schema.CreateExamReq": {
            ...
            "properties": {
                "end_time": {
                    "type": "string",
                    "format": "date-time",
                    "example": "2026-04-26T11:00:00+08:00"
                },
                "location": {
                    "type": "string",
                    "example": "教学楼A301"
        ...
        "schema.DDLDetailResp": {
            ...
            "properties": {
                "created_at": {
                    "type": "string",
                    "format": "date-time",
                    "example": "2026-03-24T10:00:00+08:00"
                },
                "deadline": {
                    "type": "string",
                    "format": "date-time",
                ...
                "status": {
                    "description": "DDL状态: 0-草稿, 1-激活, 2-过期, 3-已删除, 4-已完成",
                    "type": "integer",
                    "example": 1
                },
                "subject": {
